...
class ExpandedV6Inference:
    def __init__(self, device: str) -> None:
        import torch
        from modules.Navigable_Curiosity_Field.runtime.curiosity.curiosity_model import (
            RevisedDINOv2PanoramaFGFSV3,
            RevisedDINOv2PanoramaFGFSV3LastBlockB2,
        )
        from modules.Navigable_Curiosity_Field.runtime.curiosity.curiosity_inference import normalize_erp
        ...
        repo = Path(os.environ.get(
            "PIVOTNAV_DINOV2_REPO",
            str(package / "dinov2" / "repository"),
        ))
